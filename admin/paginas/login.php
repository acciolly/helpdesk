...
<body class="animsition">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name = "entrar">Login</button>
	...
	<?php
		if(isset($_POST['entrar'])){
			...
			$BuscaUser = $conexao->query("SELECT * FROM tb_usuario WHERE cpf LIKE '$cpf' AND senha LIKE '$senha'");
			if($BuscaUser->rowCount() > 0){
				$RSUser = $BuscaUser->fetch();
				$_SESSION['login'] = $RSUser['id'];
