<?php
	if(isset($_GET['ex'])){
		...
		try{
			$conexao->query("DELETE FROM tb_fabricante WHERE id = $ex");
...
<?php
	$SQLBusca = $conexao->query("SELECT * FROM tb_fabricante ORDER BY nome");
	$id_modal = 0;
								...
								<form action="" method="post">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href = "<?php echo '?p='.base64_encode('fabricantes').'&ex='.base64_encode($RSBusca['id']);?>" class="btn btn-primary">Confirmar</a>
										</div>
								</form>
								</div>
							</div>
                       ...
                       <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Fabricantes Cadastrados</h2>
                                    
										<a href = "?p=<?php echo base64_encode('novofabricante');?>" class="au-btn au-btn-icon au-btn--blue">
											<i class="zmdi zmdi-plus"></i>add fabricante
										</a>
											...
											<?php
												...
												while($RSBusca = $SQLBusca->fetch()){
													...
													echo "<tr>
														  ...
														  <td width = '10%'><a href='?p=".base64_encode('editafabricante')."&id=".base64_encode($RSBusca['id'])."' title = 'Editar Setor'><i class = 'fa fa-edit'></i></a></td>
														  <td>".$RSBusca['nome']."</td>";
