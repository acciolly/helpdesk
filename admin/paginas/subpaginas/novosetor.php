						...
						<form action="" method="post">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<a href = "<?php echo '?p='.base64_encode('setores');?>" class="btn btn-primary">Cancelar</a>
								...
								<?php
									if(isset($_POST['gravar'])){
										...
										$cidade = $_POST['cidade'];
										$fone = $_POST['fone'];
										$conexao->query("INSERT INTO tb_setor (nome,endereco,numero,bairro,cidade,fone) VALUES('$nome','$endereco','$numero','$bairro','$cidade','$fone')");
