   <?php
	if(isset($_GET['id'])){
		...
		$SQLBusca = $conexao->query("SELECT * FROM tb_estoque WHERE id = $id");
						...
						<form action="" method="post">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<a href = "<?php echo '?p='.base64_encode('estoques');?>" class="btn btn-secondary">Cancelar</a>
								...
								<?php
									if(isset($_POST['gravar'])){
										...
										$conexao->query("UPDATE tb_estoque SET nome = '$nome' WHERE id = $id");
