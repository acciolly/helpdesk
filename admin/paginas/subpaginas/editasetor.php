   <?php
	if(isset($_GET['id'])){
		...
		$SQLBusca = $conexao->query("SELECT * FROM tb_setor WHERE id = $id");
						...
						<form action="" method="post">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<a href = "<?php echo '?p='.base64_encode('setores');?>" class="btn btn-secondary">Cancelar</a>
								...
								<?php
									if(isset($_POST['gravar'])){
										...
										$cidade = $_POST['cidade'];
										$fone = $_POST['fone'];
										$conexao->query("UPDATE tb_setor SET nome = '$nome',endereco = '$endereco',numero = '$numero',bairro = '$bairro',cidade = '$cidade',fone = '$fone' WHERE id = $id");
