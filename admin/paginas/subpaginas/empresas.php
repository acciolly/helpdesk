<?php
	if(isset($_GET['ex'])){
		...
		try{
			$conexao->query("DELETE FROM tb_empresa WHERE id = $ex");
								...
								<form action="" method="post">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href = "<?php echo '?p='.base64_encode('empresas').'&ex='.base64_encode($RSBusca['id']);?>" class="btn btn-primary">Confirmar</a>
										</div>
								</form>
								</div>
							</div>
                       ...
                       <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Empresas Cadastradas</h2>
                                    
										<a href = "?p=<?php echo base64_encode('novaempresa');?>" class="au-btn au-btn-icon au-btn--blue">
											<i class="zmdi zmdi-plus"></i>add Empresa
										</a>
											...
											<?php
												...
												while($RSBusca = $SQLBusca->fetch()){
													...
													echo "<tr>
														  ...
														  <td width = '10%'><a href='?p=".base64_encode('editaempresa')."&id=".base64_encode($RSBusca['id'])."' title = 'Editar Empresa'><i class = 'fa fa-edit'></i></a></td>
														  <td>".$RSBusca['nome']."</td>
														  <td>".$RSBusca['cnpj']."</td>";
