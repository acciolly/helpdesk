...
-- -----------------------------------------------------
-- Table `helpdesk`.`tb_instituicao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `helpdesk`.`tb_instituicao` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `razao_social` VARCHAR(245) NOT NULL,
  `fantazia` VARCHAR(245) NULL,
  `cnpj` VARCHAR(45) NOT NULL,
  `fone` VARCHAR(45) NULL,
  `email` VARCHAR(245) NULL,
  `endereco` VARCHAR(245) NOT NULL,
  `numero` VARCHAR(45) NOT NULL,
  `bairro` VARCHAR(245) NOT NULL,
  `cidade` VARCHAR(45) NOT NULL,
  `uf` VARCHAR(45) NOT NULL,
  `cep` VARCHAR(45) NOT NULL,
  `logo` VARCHAR(245) NOT NULL,
  `lb_setor` VARCHAR(245) NOT NULL,
  `lb_departamento` VARCHAR(245) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
