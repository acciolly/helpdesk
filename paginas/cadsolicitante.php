...
<body class="animsition">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label>CPF</label>
                                    <input class="au-input au-input--full" type="text" name="cpf" placeholder="CPF" required onkeyup="maiuscula(this)"/>
                                </div>
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name = "entrar">Cadastrar</button>
	...
	<?php
		if(isset($_POST['entrar'])){
			...
			$conexao->query("INSERT INTO tb_pessoa(nome,cpf,fone,senha) VALUES('$nome','$cpf','$fone','$senha')");
			
			$BuscaUser = $conexao->query("SELECT id FROM tb_pessoa WHERE cpf LIKE '$cpf'");
			
			if($BuscaUser->rowCount() > 0){
				$RSUser = $BuscaUser->fetch();
				$_SESSION['solicitante'] = null;
